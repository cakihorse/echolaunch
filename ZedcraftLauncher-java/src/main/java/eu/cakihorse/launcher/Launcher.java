...
import eu.cakihorse.launcher.ui.panels.pages.App;
...
public class Launcher extends Application {
    ...
    private final Path launcherDir = Path.of(Helpers.generateGamePath("zedcraft-folder").getPath());
    ...
    public Launcher() {
        instance = this;
        this.logger = new Logger("[ZEDCRAFT]", Path.of(this.launcherDir.toString(), "launcher.log"));
    ...
    public boolean isUserAlreadyLoggedIn() {
        if (saver.get("accessToken") != null && saver.get("clientToken") != null) {
            ...
            MicrosoftAuthResult response = null;
            try {
                MicrosoftAuthenticator authenticator = new MicrosoftAuthenticator();
                response = authenticator.loginWithRefreshToken(saver.get("msRefreshToken"));
