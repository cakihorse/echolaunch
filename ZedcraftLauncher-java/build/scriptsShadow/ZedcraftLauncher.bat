...
set CLASSPATH=%APP_HOME%\lib\ZedcraftLauncher-1.0.0-all.jar

@rem Execute ZedcraftLauncher
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ZEDCRAFT_LAUNCHER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%ZEDCRAFT_LAUNCHER_EXIT_CONSOLE%" exit 1
exit /b 1
